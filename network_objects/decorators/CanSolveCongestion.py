class CanSolveCongestion:
    ...
    def check_action(self, action_kwh):
        ...
        if adjusted_action_kwh != action_kwh and self.network_object.verbose_lvl > 2:
            print('Action was adjusted to solve congestion')
    ...
    def take_step(self, environment_step, action_parameters):
        ...
        if congestion_power_kw > 0.95 * self.congestion_kw:
