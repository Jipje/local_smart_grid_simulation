...
class Battery(NetworkObject):
    ...
    def end_of_environment_message(self, num_of_days=None):
        ...
        average_earnings = round(self.earnings / num_of_days, 2)
        res_msg = "\n{} battery:\n\t" \
            ...
            "Average earnings: {}".format(self.name,
                                          ...
                                          self.earnings, self.average_soc, average_num_changes_of_direction,
                                          average_num_of_cycles, average_earnings)
        return res_msg
