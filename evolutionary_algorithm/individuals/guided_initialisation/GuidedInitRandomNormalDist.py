...
from evolutionary_algorithm.individuals.guided_initialisation.GuidedStrategyIndividual import GuidedStrategyIndividual
...
class GuidedInitRandomNormalDist(GuidedStrategyIndividual):

    def pair(self, other, pair_params):
        new_individual = self.make_new_individual(other, pair_params)
        return GuidedInitRandomNormalDist(new_individual)
...
if __name__ == '__main__':
    ...
    other = GuidedInitRandomNormalDist(init_params=init_params)
    init_params['seed'] = 6618115003047519509
    current = GuidedInitRandomNormalDist(init_params=init_params)
