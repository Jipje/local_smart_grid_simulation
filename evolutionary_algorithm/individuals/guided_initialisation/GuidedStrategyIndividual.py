...
class GuidedStrategyIndividual(Individual):

    def pair(self, other, pair_params):
        new_individual = self.make_new_individual(other, pair_params)
        return GuidedStrategyIndividual(new_individual)
...
if __name__ == '__main__':
    ...
    other = GuidedStrategyIndividual(init_params=init_params)
    init_params['seed'] = 6618115003047519509
    current = GuidedStrategyIndividual(init_params=init_params)
