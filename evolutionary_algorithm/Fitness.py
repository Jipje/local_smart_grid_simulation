...
if __name__ == '__main__':
    scenario = '../data/environments/lelystad_1_2021.csv'
    res_df = pd.read_csv(scenario)
    dict_of_df = res_df.to_dict('records')
    ...
    random_point_based_strategy = RandomStrategyGenerator.generate_random_discharge_relative_strategy()
    ...
    run_simulation_from_dict_of_df(starting_timestep, number_of_steps, scenario=scenario, verbose_lvl=verbose_lvl,
                                   simulation_environment=imbalance_environment, dict_of_df=dict_of_df)
