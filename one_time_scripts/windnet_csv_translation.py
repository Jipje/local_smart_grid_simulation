        ...
        for wind_net_data in csv_reader:
            ...
            while time_tracker < end_of_5m_interval:
                ...
                new_row = {
                    ...
                    'neushoorntocht_consumed_kw': neushoorntocht_consumed_kw,
                    'neushoorntocht_produced_kw': neushoorntocht_produced_kw,
                    'mammoettocht_consumed_kw': mammoettocht_consumed_kw,
                    'mammoettocht_produced_kw': mammoettocht_produced_kw
                }
