...
if __name__ == '__main__':
    tennet_delta_df = pd.read_csv('data/tennet_balans_delta_sep_2020_sep_2021.csv')
    ...
    with open('data/larger_tennet_balans_delta_and_trivial_windnet.csv','w+', newline='') as new_file:
        ...
        for index, row in res_df.iterrows():
            ...
            tennet_max = row['tennet_balansdelta.mean_max_price']
            if tennet_max == 0.0:
                tennet_max = -99999

            tennet_min = row['tennet_balansdelta.mean_min_price']
            if tennet_min == 0.0:
                tennet_min = 99999

            csv_row = [index_str, tennet_max, row['tennet_balansdelta.mean_mid_price'],
                       tennet_min, row['neushoorntocht_consumed_kw'],
