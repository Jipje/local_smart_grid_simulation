...
class TestNetworkEnvironment(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        try:
            Battery('TestNetworkEnvironment', 7500, 12000, battery_strategy_csv=strategy_one_path, starting_soc_kwh=0)
    ...
    def test_simple_congestion(self):
        ...
        rhino = Battery('test_simple_congestion', 7500, 12000, battery_strategy_csv=self.strategy_one_path, starting_soc_kwh=3750)
    ...
    def test_simple_imbalance(self):
        ...
        rhino = Battery('test_simple_imbalance', 7500, 12000, battery_strategy_csv=self.strategy_one_path, starting_soc_kwh=3750)
    ...
    def test_congestion_and_imbalance(self):
        ...
        TotalNetworkCapacityTracker(network, 10000)
        ImbalanceEnvironment(network, 1, 0, 2)
        rhino = Battery('test_congestion_and_imbalance', 7500, 12000, battery_strategy_csv=self.strategy_one_path, starting_soc_kwh=3750)
        network.add_object(rhino, [0, 2])
        network.take_step([200, 100, 99999])
