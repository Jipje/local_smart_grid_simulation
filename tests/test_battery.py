...
class TestBattery(unittest.TestCase):
    def test_nice_initialization(self):
        # Empty battery
        rhino_battery = Battery('TEST', 7500, 12000, battery_strategy_csv=strategy_one_path, starting_soc_kwh=0)
        ...
        rhino_battery = Battery('TEST', 7500, 12000, battery_strategy_csv=strategy_one_path, battery_efficiency=0.8)
        self.assertEqual(rhino_battery.name, 'TEST')
        ...
        rhino_battery = Battery('TEST', 7500, 12000, battery_strategy_csv=strategy_one_path, starting_soc_kwh=3000)
        self.assertEqual(rhino_battery.name, 'TEST')
        self.assertEqual(rhino_battery.efficiency, 0.9)
    ...
    def test_faulty_initialization(self):
        # Faulty max_kwh
        self.assertRaises(ValueError, Battery, 'TEST', 0, 12000, battery_strategy_csv=strategy_one_path)
        self.assertRaises(ValueError, Battery, 'TEST', -7500, 12000, battery_strategy_csv=strategy_one_path)
        # Faulty max_kw
        self.assertRaises(ValueError, Battery, 'TEST', 7500, 0, battery_strategy_csv=strategy_one_path)
        self.assertRaises(ValueError, Battery, 'TEST', 7500, -12000, battery_strategy_csv=strategy_one_path)
        # Faulty battery_efficiency
        self.assertRaises(ValueError, Battery, 'TEST', 7500, 12000, battery_strategy_csv=strategy_one_path, battery_efficiency=-0.9)
        self.assertRaises(ValueError, Battery, 'TEST', 7500, 12000, battery_strategy_csv=strategy_one_path, battery_efficiency=0)
        self.assertRaises(ValueError, Battery, 'TEST', 7500, 12000, battery_strategy_csv=strategy_one_path, battery_efficiency=1.1)
        # Faulty starting_soc_kwh
        self.assertRaises(ValueError, Battery, 'TEST', 7500, 12000, battery_strategy_csv=strategy_one_path, starting_soc_kwh=-100)
        self.assertRaises(ValueError, Battery, 'TEST', 7500, 12000, battery_strategy_csv=strategy_one_path, starting_soc_kwh=7501)

    def test_nice_update_earnings(self):
        rhino_battery = Battery('TEST', 7500, 12000, battery_strategy_csv=strategy_one_path)
    ...
    def test_nice_charge_and_discharge(self):
        ...
        rhino_battery = Battery('TEST', 7500, 12000, battery_strategy_csv=strategy_one_path, battery_efficiency=1)
        self.assertEqual(rhino_battery.state_of_charge_kwh, 3750)
        rhino_battery.charge(6760, 500)
    ...
    def test_weird_charge(self):
        # Battery too full
        rhino_battery = Battery('TEST', 7500, 12000, battery_strategy_csv=strategy_one_path, starting_soc_kwh=7400)
        ...
        rhino_battery = Battery('TEST', 7500, 12000, battery_strategy_csv=strategy_one_path, starting_soc_kwh=7200)
    ...
    def test_weird_discharge(self):
        # Battery too empty
        rhino_battery = Battery('TEST', 7500, 12000, battery_strategy_csv=strategy_one_path, starting_soc_kwh=100)
        self.assertEqual(rhino_battery.state_of_charge_kwh, 100)
        rhino_battery.discharge(12000, 500)
        self.assertEqual(rhino_battery.state_of_charge_kwh, 0)
        # Discharge too large
        rhino_battery = Battery('TEST', 7500, 12000, battery_strategy_csv=strategy_one_path, starting_soc_kwh=500)
